...
class AddressBook:
    def __init__(self):
        ...
        Entry(frame3, textvariable=self.cityVar).grid(row=1,column=2,sticky=W)
        Label(frame3, text="State", width=5).grid(row=1,column=3,sticky=W)
    ...
    def processAdd(self):
        address = Address(self.nameVar.get(), self.stateVar.get(), self.cityVar.get(),
